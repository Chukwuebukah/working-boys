    ...
    <div className="min-h-screen bg-gray-50 w-full md:ml-64 p-2 xs:p-4 sm:p-6">
      ...
      <div className="max-w-4xl mx-auto w-full">
        <div className="text-center mb-8 sm:mb-12">
          ...
          <p className="text-base xs:text-lg sm:text-xl text-gray-600">Select your preferred wallet or exchange to withdraw funds</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-4 xs:p-6 sm:p-8">
          ...
          <div className="grid grid-cols-1 xs:grid-cols-2 gap-4 sm:gap-8">
            ...
            <div>
              ...
              <p className="text-gray-600 text-xs sm:text-base">Experience quick withdrawal confirmations and seamless integration with our platform.</p>
            </div>
            <div>
        ...
        <div className="mt-8 sm:mt-12 text-center px-2">
          <div className="bg-gradient-to-r from-blue-500 to-purple-600 rounded-2xl p-4 xs:p-6 sm:p-8 text-white">
            ...
            <p className="text-base xs:text-lg sm:text-xl mb-4 sm:mb-6">Our support team is available 24/7 to assist you with withdrawals and any questions.</p>
