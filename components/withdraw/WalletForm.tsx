    ...
    <div className="max-w-2xl mx-auto">
      ...
      <div className="bg-white rounded-2xl shadow-lg p-8 mb-6">
        ...
        <div className="w-full flex flex-col gap-1">
          ...
          <button
            className="w-full bg-gradient-to-r from-[#1C1333] to-[#2a1d4d] text-white font-bold py-3 rounded-xl text-lg shadow-lg hover:from-[#2a1d4d] hover:to-[#1C1333] transition-colors mt-4 flex items-center justify-center gap-2"
            type="button"
            disabled={loading}
            onClick={() => {
              setLoading(true)
          ...
          >
            {loading ? <Loader2 className="animate-spin w-6 h-6" /> : <span>Submit</span>}
          </button>
        </form>
