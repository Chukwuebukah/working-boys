...
const Hero = () => {
  return (
  <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16 [background:#1C1333] px-2 sm:px-4">
      {/* Background Effects */}
      ...
      <div className="relative max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="text-center lg:text-left w-full">
            ...
            <p className="text-base xs:text-lg sm:text-xl text-gray-300 mb-6 sm:mb-8 leading-relaxed max-w-2xl mx-auto lg:mx-0">
            ...
            <div className="flex flex-col xs:flex-row gap-3 sm:gap-4 justify-center lg:justify-start w-full">
              <a href="/sign-up" className="bg-white text-black font-bold px-6 py-3 rounded-md flex items-center justify-center space-x-2 cursor-pointer w-full xs:w-auto">
                GET STARTED
              </a>
            </div>
            {/* Stats */}
            <div className="mt-8 sm:mt-12 grid grid-cols-1 xs:grid-cols-3 gap-4 sm:gap-6 text-center lg:text-left w-full">
              <div>
                <div className="text-xl sm:text-2xl font-bold text-white">10K+</div>
                <div className="text-gray-400 text-xs sm:text-sm">Tokens Created</div>
              </div>
              <div>
          ...
          <div className="relative flex items-center justify-center mt-10 lg:mt-0">
            <div className="relative w-60 h-60 xs:w-72 xs:h-72 sm:w-80 sm:h-80">
